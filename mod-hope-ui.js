...
// znajdz obecne elementy na stronie i do nich sie podepnij
Array.from(document.getElementsByClassName('circle-progress')).filter(x => x).forEach(initializeProgressBar);
/*---------------------------------------------------------------------
              Progress Bar
-----------------------------------------------------------------------*/
