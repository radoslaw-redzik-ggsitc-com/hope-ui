        ...
        o--); o < l; o++)
            if (null != (e = arguments[o]))
                for (t in e)
                    ...
                    a = i && !Array.isArray(n) ? [] : i || x.isPlainObject(n) ? n : {},
                    i = !1,
                    s[t] = x.extend(c, a, r)) : void 0 !== r && (s[t] = r));
        return s
    }
    ,
    x.extend({
 ...
 */
    function(e) {
        var t, n, r, i, a, s, o, l, c, u, d, p, f, h, m, g, v, b, y, w = "sizzle" + 1 * new Date, x = e.document, T = 0, S = 0, _ = le(), C = le(), E = le(), D = le(), A = function(e, t) {
            return e === t && (d = !0),
            0
        }, k = {}.hasOwnProperty, L = [], M = L.pop, P = L.push, I = L.push, O = L.slice, N = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, j = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", z = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + z + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", $ = "\\[" + z + "*(" + H + ")(?:" + z + "*([*^$|!~]?=)" + z + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + z + "*\\]", F = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)", R = new RegExp(z + "+","g"), B = new RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$","g"), W = new RegExp("^" + z + "*," + z + "*"), q = new RegExp("^" + z + "*([>+~]|" + z + ")" + z + "*"), X = new RegExp(z + "|>"), V = new RegExp(F), G = new RegExp("^" + H + "$"), Y = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
            TAG: new RegExp("^(" + H + "|[*])"),
            ATTR: new RegExp("^" + $),
        ...
        }, U = /HTML$/i, K = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, Q = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + z + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
        ...
        try {
            I.apply(L = O.call(x.childNodes), x.childNodes),
        ...
        function oe(e, t, r, i) {
            var a, o, c, u, d, h, v, b = t && t.ownerDocument, x = t ? t.nodeType : 9;
            if (r = r || [],
                    ...
                    if (a = d[1]) {
                        if (9 === x) {
                            ...
                            if (c.id === a)
                                return r.push(c),
                                r
                        } else if (b && (c = b.getElementById(a)) && y(t, c) && c.id === a)
                            return r.push(c),
                            r
                    } else {
                        if (d[2])
                        ...
                        if ((a = d[3]) && n.getElementsByClassName && t.getElementsByClassName)
                            return I.apply(r, t.getElementsByClassName(a)),
                            r
                    }
                if (n.qsa && !D[e + " "] && (!g || !g.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                    if (v = e,
                    b = t,
                    1 === x && (X.test(e) || q.test(e))) {
                        for ((b = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(re, ie) : t.setAttribute("id", u = w)),
                        o = (h = s(e)).length; o--; )
                            h[o] = (u ? "#" + u : ":scope") + " " + ye(h[o]);
                        v = h.join(",")
                    }
                    try {
                        return I.apply(r, b.querySelectorAll(v)),
                        r
                    } catch (t) {
                        D(e, !0)
                    } finally {
        ...
        p = oe.setDocument = function(e) {
            ...
            m = !a(f),
            x != f && (i = f.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", ae, !1) : i.attachEvent && i.attachEvent("onunload", ae)),
            ...
            v = [],
            g = [],
            (n.qsa = Q.test(f.querySelectorAll)) && (ue((function(e) {
                var t;
            ...
            y = t || Q.test(h.contains) ? function(e, t) {
            ...
            A = t ? function(e, t) {
                ...
                return r || (1 & (r = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e == f || e.ownerDocument == x && y(x, e) ? -1 : t == f || t.ownerDocument == x && y(x, t) ? 1 : u ? N(u, e) - N(u, t) : 0 : 4 & r ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return d = !0,
                ...
                if (!i || !a)
                    return e == f ? -1 : t == f ? 1 : i ? -1 : a ? 1 : u ? N(u, e) - N(u, t) : 0;
                if (i === a)
                    return pe(e, t);
        ...
        oe.matchesSelector = function(e, t) {
            if (p(e),
            n.matchesSelector && m && !D[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t)))
                try {
                    var r = b.call(e, t);
        ...
        oe.attr = function(e, t) {
            ...
            var i = r.attrHandle[t.toLowerCase()]
              , a = i && k.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !m) : void 0;
        ...
        r = oe.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, l) {
                        var c, u, d, p, f, h, m = a !== s ? "nextSibling" : "previousSibling", g = t.parentNode, v = o && t.nodeName.toLowerCase(), b = !l && !o, y = !1;
                        if (g) {
                            if (a) {
                                for (; m; ) {
                                    for (p = t; p = p[m]; )
                            ...
                            s && b) {
                                for (y = (f = (c = (u = (d = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2],
                                p = f && g.childNodes[f]; p = ++f && p && p[m] || (y = f = 0) || h.pop(); )
                                    if (1 === p.nodeType && ++y && p === t) {
                                        u[e] = [T, f, y];
                                        break
                                    }
                            } else if (b && (y = f = (c = (u = (d = (p = t)[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === T && c[1]),
                            !1 === y)
                                for (; (p = ++f && p && p[m] || (y = f = 0) || h.pop()) && ((o ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++y || (b && ((u = (d = p[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [T, y]),
                                p !== t)); )
                                    ;
            ...
            ce((function(a, s, o, l) {
                var c, u, d, p = [], f = [], h = s.length, m = a || function(e, t, n) {
                    for (var r = 0, i = t.length; r < i; r++)
                        oe(e, t[r], n);
                    return n
                }(t || "*", o.nodeType ? [o] : o, []), g = !e || !a && t ? m : Te(m, p, e, o, l), v = n ? i || (a ? e : h || r) ? [] : s : g;
                if (n && n(g, v, o, l),
                r)
                    for (c = Te(v, f),
                    r(c, [], o, l),
                ...
                if (a) {
                    if (i || e) {
                        ...
                        for (u = v.length; u--; )
                            (d = v[u]) && (c = i ? N(a, d) : p[u]) > -1 && (a[c] = !(s[c] = d))
                    }
                } else
                    v = Te(v === s ? v.splice(h, v.length) : v),
                    i ? i(null, s, v, l) : I.apply(s, v)
            }
            ))
        }
        function _e(e) {
                ...
                if (n = r.relative[e[l].type])
                    ...
                    if ((n = r.filter[e[l].type].apply(null, e[l].matches))[w]) {
                        ...
                        return Se(l > 1 && xe(p), l > 1 && ye(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(B, "$1"), n, l < i && _e(e.slice(l, i)), i < a && _e(e = e.slice(i)), i < a && ye(e))
                    }
                    p.push(n)
                }
            return xe(p)
        }
        return be.prototype = r.filters = r.pseudos,
        r.setFilters = new be,
        s = oe.tokenize = function(e, t) {
            ...
            l = [],
            c = r.preFilter; o; ) {
                for (s in n && !(i = W.exec(o)) || (i && (o = o.slice(i[0].length) || o),
                l.push(a = [])),
                n = !1,
                ...
                o = o.slice(n.length)),
                r.filter)
                    !(i = Y[s].exec(o)) || c[s] && !(i = c[s](i)) || (n = i.shift(),
                    a.push({
                        value: n,
                        type: s,
                        matches: i
                ...
                o = E(e, function(e, t) {
                    var n = t.length > 0
                      ...
                      , a = function(a, s, o, l, u) {
                        var d, h, g, v = 0, b = "0", y = a && [], w = [], x = c, S = a || i && r.find.TAG("*", u), _ = T += null == x ? 1 : Math.random() || .1, C = S.length;
                        for (u && (c = s == f || s || u); b !== C && null != (d = S[b]); b++) {
                            if (i && d) {
                                for (h = 0,
                        ...
                        n && b !== v) {
                            ...
                            I.apply(l, w),
                            u && !a && w.length > 0 && v + t.length > 1 && oe.uniqueSort(l)
                        }
                        return u && (T = _,
                        c = x),
                        y
        ...
        l = oe.select = function(e, t, n, i) {
            ...
            return (p || o(e, f))(i, t, !m, n, !t || ee.test(e) && ve(t.parentNode) || t),
            n
        }
        ,
    ...
    x.fn.extend({
        ...
        is: function(e) {
            return !!k(this, "string" == typeof e && E.test(e) ? x(e) : e || [], !1).length
        }
    });
    var L, M = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (x.fn.init = function(e, t, n) {
        ...
        "string" == typeof e) {
            ...
            if (r[1]) {
                ...
                x.merge(this, x.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : g, !0)),
    ...
    x.each({
        ...
        contents: function(e) {
            return null != e.contentDocument && r(e.contentDocument) ? e.contentDocument : (D(e, "template") && (e = e.content || e),
        ...
        x.fn[e] = function(n, r) {
            ...
            this.length > 1 && (I[e] || x.uniqueSort(i),
            P.test(e) && i.reverse()),
            this.pushStack(i)
        }
    }
            ...
            add: function() {
                ...
                function t(n) {
                    x.each(n, (function(n, r) {
                        h(r) ? e.unique && c.has(r) || a.push(r) : r && r.length && "string" !== y(r) && t(r)
                    }
                    ))
                }(arguments),
                n && !t && l()),
              ...
              , i = {
                ...
                then: function(t, r, i) {
                            ...
                            var o = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < a)) {
                                    ...
                                    h(c) ? i ? c.call(e, s(a, n, j, i), s(a, n, z, i)) : (a++,
                                    c.call(e, s(a, n, j, i), s(a, n, z, i), s(a, n, j, n.notifyWith))) : (r !== j && (o = void 0,
                                    l = [e]),
                                    (i || n.resolveWith)(o, l))
                                }
                            }
                    ...
                    return x.Deferred((function(e) {
                        n[0][3].add(s(0, e, h(i) ? i : j, e.notifyWith)),
                        n[1][3].add(s(0, e, h(t) ? t : j)),
                        n[2][3].add(s(0, e, h(r) ? r : z))
                    }
                    )).promise()
                },
                promise: function(e) {
    ...
    x.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --x.readyWait > 0 || F.resolveWith(g, [x]))
        }
    }),
    x.ready.then = F.then,
    ...
    x.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                r = U.get(e, t),
                n && (!r || Array.isArray(n) ? r = U.access(e, t, x.makeArray(n)) : r.push(n)),
                r || []
        },
    ...
    x.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; s--; )
                (n = U.get(a[s], e + "queueHooks")) && n.empty && (r++,
                n.empty.add(o));
            return o(),
            i.promise(t)
        }
    ...
    function oe(e, t, n, r) {
        ...
        , l = o(), c = n && n[3] || (x.cssNumber[t] ? "" : "px"), u = e.nodeType && (x.cssNumber[t] || "px" !== c && +l) && te.exec(x.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; s--; )
    ...
    function ue(e, t) {
        for (var n, r, i = [], a = 0, s = e.length; a < s; a++)
            ...
            t ? ("none" === n && (i[a] = U.get(r, "display") || null,
            i[a] || (r.style.display = "")),
            "" === r.style.display && se(r) && (i[a] = ce(r))) : "none" !== n && (i[a] = "none",
            U.set(r, "display", n)));
        for (a = 0; a < s; a++)
    ...
    function we(e, t, n, r, i) {
        ...
        for (d.textContent = "",
        f = 0; a = p[f++]; )
            if (r && x.inArray(a, r) > -1)
                i && i.push(a);
            else if (c = ie(a),
            s = ve(d.appendChild(a), "script"),
            c && be(s),
            n)
                for (u = 0; a = s[u++]; )
    ...
    x.event = {
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(N) || [""]).length; c--; )
                    ...
                    f) {
                        ...
                        s && !p.length && (d.teardown && !1 !== d.teardown.call(e, h, g.handle) || x.removeEvent(e, f, g.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(e) {
            var t, n, r, i, a, s, o = new Array(arguments.length), l = x.event.fix(e), c = (U.get(this, "events") || Object.create(null))[l.type] || [], u = x.event.special[l.type] || {};
            for (o[0] = l,
            ...
            !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                ...
                t = 0; (i = s[t++]) && !l.isPropagationStopped(); )
                    ...
                    n = 0; (a = i.handlers[n++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = a.data,
                        void 0 !== (r = ((x.event.special[a.origType] || {}).handle || a.handler).apply(i.elem, o)) && !1 === (l.result = r) && (l.preventDefault(),
                        l.stopPropagation()));
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && D(t, "input") && Ee(t, "click", Te),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && D(t, "input") && Ee(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
        ...
        s || r)) {
            ...
            if (l)
                ...
                d = 0; d < l; d++)
                    ...
                    }, u) : b(c.textContent.replace(ke, ""), c, u))
        }
        return e
    }
    function je(e, t, n) {
        for (var r, i = t ? x.filter(t, e) : e, a = 0; null != (r = i[a]); a++)
            ...
            r.parentNode && (n && ie(r) && be(ve(r, "script")),
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    Ie(e, o);
            return (s = ve(o, "script")).length > 0 && be(s, !l && ve(e, "script")),
            o
        },
    ...
    function qe(e, t, n) {
        var r, i, a, s, o = He.test(t), l = e.style;
        return (n = n || $e(e)) && (s = n.getPropertyValue(t) || n[t],
        o && s && (s = s.replace(We, "$1") || void 0),
        "" !== s || ie(e) || (s = x.style(e, t)),
        !f.pixelBoxStyles() && ze.test(s) && Re.test(t) && (r = l.width,
        i = l.minWidth,
        a = l.maxWidth,
    ...
    function et(e, t, n, r, i, a) {
        ...
        for (; s < 4; s += 2)
            ...
            r ? ("content" === n && (l -= x.css(e, "padding" + ne[s], !0, i)),
    ...
    function tt(e, t, n) {
        ...
        return (!f.boxSizingReliable() && i || !f.reliableTrDimensions() && D(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === x.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === x.css(e, "boxSizing", !1, r),
        (a = o in e) && (s = e[o])),
        (s = parseFloat(s) || 0) + et(e, t, n || (i ? "border" : "content"), a, r, s) + "px"
    }
    ...
    x.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, a, s, o = V(t), l = He.test(t), c = e.style;
                if (l || (t = Ue(o)),
                s = x.cssHooks[t] || x.cssHooks[o],
                void 0 === n)
                    return s && "get"in s && void 0 !== (i = s.get(e, !1, r)) ? i : c[t];
                "string" === (a = typeof n) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i),
                a = "number"),
                null != n && n == n && ("number" !== a || l || (n += i && i[3] || (x.cssNumber[o] ? "" : "px")),
    ...
    x.each(["height", "width"], (function(e, t) {
        x.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !Ke.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, r) : Fe(e, Je, (function() {
                        return tt(e, t, r)
                    }
                    ))
            },
            set: function(e, n, r) {
                var i, a = $e(e), s = !f.scrollboxSize() && "absolute" === a.position, o = (s || r) && "border-box" === x.css(e, "boxSizing", !1, a), l = r ? et(e, t, r, o, a) : 0;
                return o && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(a[t]) - et(e, t, "border", !1, a) - .5)),
    ...
    x.cssHooks.marginLeft = Xe(f.reliableMarginLeft, (function(e, t) {
        if (t)
    ...
    function ot() {
        it && (!1 === g.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(ot) : e.setTimeout(ot, x.fx.interval),
        x.fx.tick())
    }
    function lt() {
    ...
    function dt(e, t, n) {
        var r, i, a = 0, s = dt.prefilters.length, o = x.Deferred().always((function() {
            delete l.elem
        }
        )), l = function() {
            if (i)
                return !1;
            for (var t = rt || lt(), n = Math.max(0, c.startTime + c.duration - t), r = 1 - (n / c.duration || 0), a = 0, s = c.tweens.length; a < s; a++)
                c.tweens[a].run(r);
        ...
        for (!function(e, t) {
            ...
            if (r = dt.prefilters[a].call(c, e, u, c.opts))
                return h(r.stop) && (x._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)),
                r;
        return x.map(u, ut, c),
    ...
    x.Animation = x.extend(dt, {
        ...
        prefilters: [function(e, t, n) {
            var r, i, a, s, o, l, c, u, d = "width"in t || "height"in t, p = this, f = {}, h = e.style, m = e.nodeType && se(e), g = U.get(e, "fxshow");
    ...
    x.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== a && 8 !== a && 2 !== a)
                return void 0 === e.getAttribute ? x.prop(e, t, n) : (1 === a && x.isXMLDoc(e) || (i = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? pt : void 0)),
    ...
    x.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            )) : "boolean" == typeof t && o ? t ? this.addClass(e) : this.removeClass(e) : (n = bt(e),
            this.each((function() {
                if (o)
                    for (a = x(this),
                    i = 0; i < n.length; i++)
                    ...
                    void 0 !== e && "boolean" !== s || ((r = vt(this)) && U.set(this, "__className__", r),
                    this.setAttribute && this.setAttribute("class", r || !1 === e ? "" : U.get(this, "__className__") || ""))
            }
            )))
        },
        hasClass: function(e) {
    ...
    x.fn.extend({
        val: function(e) {
            ...
            ))) : i ? (t = x.valHooks[i.type] || x.valHooks[i.nodeName.toLowerCase()]) && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof (n = i.value) ? n.replace(yt, "") : null == n ? "" : n : void 0
        }
    }),
    x.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, i = e.options, a = x.makeArray(t), s = i.length; s--; )
                        ((r = i[s]).selected = x.inArray(x.valHooks.option.get(r), a) > -1) && (n = !0);
    ...
    x.extend(x.event, {
        trigger: function(t, n, r, i) {
            var a, s, o, l, c, d, p, f, v = [r || g], b = u.call(t, "type") ? t.type : t, y = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = f = o = r = r || g,
            3 !== r.nodeType && 8 !== r.nodeType && !wt.test(b + x.event.triggered) && (b.indexOf(".") > -1 && (y = b.split("."),
            b = y.shift(),
            y.sort()),
            c = b.indexOf(":") < 0 && "on" + b,
            (t = t[x.expando] ? t : new x.Event(b,"object" == typeof t && t)).isTrigger = i ? 2 : 3,
            t.namespace = y.join("."),
            ...
            i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !m(r)) {
                    ...
                    wt.test(l + b) || (s = s.parentNode); s; s = s.parentNode)
                        v.push(s),
                        o = s;
                ...
                for (a = 0; (s = v[a++]) && !t.isPropagationStopped(); )
                    ...
                    (d = (U.get(s, "events") || Object.create(null))[t.type] && U.get(s, "handle")) && d.apply(s, n),
                    (d = c && s[c]) && d.apply && G(s) && (t.result = d.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = b,
                i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !G(r) || c && h(r[b]) && !m(r) && ((o = r[c]) && (r[c] = null),
                x.event.triggered = b,
                t.isPropagationStopped() && f.addEventListener(b, xt),
                r[b](),
                t.isPropagationStopped() && f.removeEventListener(b, xt),
    ...
    x.fn.extend({
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && At.test(this.nodeName) && !Dt.test(e) && (this.checked || !fe.test(e))
            }
            )).map((function(e, t) {
                var n = x(this).val();
    ...
    x.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, i, a, s, o, l, c, u, d, p, f = x.ajaxSetup({}, n), h = f.context || f, m = f.context && (h.nodeType || h.jquery) ? x(h) : x.event, v = x.Deferred(), b = x.Callbacks("once memory"), y = f.statusCode || {}, w = {}, T = {}, S = "canceled", _ = {
                readyState: 0,
            ...
            delete f.data),
            !1 === f.cache && (i = i.replace(Pt, "$1"),
            p = (_t.test(i) ? "&" : "?") + "_=" + St.guid++ + p),
            f.url = i + p),
            f.ifModified && (x.lastModified[i] && _.setRequestHeader("If-Modified-Since", x.lastModified[i]),
            ...
            _.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ht + "; q=0.01" : "") : f.accepts["*"]),
            f.headers)
            ...
            function C(t, n, s, l) {
                ...
                d ? (f.ifModified && ((T = _.getResponseHeader("Last-Modified")) && (x.lastModified[i] = T),
                ...
                _.status = t,
                _.statusText = (n || S) + "",
                d ? v.resolveWith(h, [p, S, _]) : v.rejectWith(h, [_, S, g]),
                _.statusCode(y),
                y = void 0,
                ...
                send: function(i, a) {
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? o.abort() : "error" === e ? "number" != typeof o.status ? a(0, "error") : a(o.status, o.statusText) : a(Wt[o.status] || o.status, o.statusText, "text" !== (o.responseType || "text") || "string" != typeof o.responseText ? {
                                binary: o.response
                            } : {
                                text: o.responseText
    ...
    x.ajaxPrefilter("json jsonp", (function(t, n, r) {
        var i, a, s, o = !1 !== t.jsonp && (Gt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Gt.test(t.data) && "data");
        if (o || "jsonp" === t.dataTypes[0])
            return i = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            o ? t[o] = t[o].replace(Gt, "$1" + i) : !1 !== t.jsonp && (t.url += (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    f.createHTMLDocument = ((Xt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    x.parseHTML = function(e, t, n) {
        ...
        a = !n && [],
        (i = A.exec(e)) ? [t.createElement(i[1])] : (i = we([e], t, a),
    ...
    x.each(["top", "left"], (function(e, t) {
        x.cssHooks[t] = Xe(f.pixelPosition, (function(e, n) {
            if (n)
                return n = qe(e, t),
        ...
        x.each({
            ...
            x.fn[r] = function(i, a) {
                ...
                return B(this, (function(t, n, i) {
                    ...
                    Math.max(t.body["scroll" + e], a["scroll" + e], t.body["offset" + e], a["offset" + e], a["client" + e])) : void 0 === i ? x.css(t, n, o) : x.style(t, n, i, o)
                }
                ), t, s ? i : void 0, s)
            }
        }
